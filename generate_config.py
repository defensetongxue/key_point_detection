...
for m_n in model_names:
    for lr in lr_lists:
        ...
        with open(json_file_path,'w') as f:
            ...
            sh_f.write(f"python -u train_cls.py --cfg {json_file_path} --save_name {str(cfg_cnt)}\n")
            sh_f.write(f"python -u test_cls.py --cfg {json_file_path} --save_name {str(cfg_cnt)}\n")
        cfg_cnt+=1
